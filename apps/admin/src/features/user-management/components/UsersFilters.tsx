...
export function UsersFilters({
  ...
  const chipBase =
    'px-3 py-1.5 rounded-full font-caption-ar text-xs transition-all flex items-center gap-1 cursor-pointer';
  const chipActive = 'bg-primary-container text-on-primary shadow-sm scale-105';
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <button
          ...
          className={`flex items-center gap-1.5 font-caption-ar text-caption-ar hover:text-primary/80 transition-all px-3 py-2 rounded-lg border ${
        ...
        >
          ...
          {activeAdvancedCount > 0 && (
            <span className="bg-primary-container text-on-primary w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold">
              {activeAdvancedCount}
            </span>
          )}
        </button>
      ...
      {showAdvanced && (
        <div
          className="bg-surface-container-low border border-outline-variant/40 rounded-xl p-5 shadow-sm space-y-4 animate-in slide-in-from-top duration-250 ease-out"
          dir="rtl"
        >

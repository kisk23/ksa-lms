      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-pulse">
        ...
        <div className="lg:col-span-4">
          <div className="rounded-xl border-2 border-border p-6 flex flex-col gap-5 bg-surface">
            {/* Price */}
            <div className="h-10 w-28 mx-auto bg-surface-hover rounded-lg" />
            {/* CTA button */}
            ...
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="flex gap-3 items-center">
                ...
                <div className="h-3 flex-1 bg-surface-hover rounded" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="lg:col-span-8 flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="h-9 w-3/4 bg-surface-hover rounded" />
            <div className="h-5 w-full bg-surface-hover rounded" />
            <div className="h-5 w-5/6 bg-surface-hover rounded" />
            {/* Meta row */}
            <div className="flex gap-6 mt-2">
              <div className="h-8 w-32 bg-surface-hover rounded-full" />
              <div className="h-8 w-24 bg-surface-hover rounded-full" />
          ...
          <div className="p-6 rounded-xl border border-border bg-surface">
            <div className="h-6 w-36 bg-surface-hover rounded mb-5" />
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="flex gap-3 items-start">
                  <div className="w-5 h-5 rounded-full bg-surface-hover shrink-0 mt-0.5" />
          ...
          <div className="flex flex-col gap-3">
            ...
            {Array.from({ length: 3 }).map((_, i) => (
              <div
                key={i}
                className="h-14 rounded-lg border-2 border-border bg-surface-hover"
              />
            ))}
          </div>
          ...
          <div className="p-6 rounded-xl border-2 border-border bg-surface flex flex-col sm:flex-row gap-6">
            ...
            <div className="flex flex-col gap-3 flex-1">
              ...
              <div className="h-4 w-52 bg-surface-hover rounded" />
              <div className="h-4 w-full  bg-surface-hover rounded" />
              <div className="h-4 w-4/5  bg-surface-hover rounded" />
            </div>
          </div>
